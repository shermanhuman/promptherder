...
// promptherderHeader is the marker embedded in all generated files. Used to
// detect whether an existing file was created by promptherder (safe to
// overwrite) or is a foreign file that should not be destroyed.
const promptherderHeader = "Auto-generated by promptherder"
